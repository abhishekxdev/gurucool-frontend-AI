...
const TeacherPending: React.FC<TeacherPendingProps> = ({
  ...
  const [selectedTeacher, setSelectedTeacher] = React.useState<TeacherDirectoryEntry | undefined>();
        ...
        {showFiltersAndSearch && (
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Select
                value={
                  (table.getColumn("approvalStatus")?.getFilterValue() as string) ||
                  "all"
                }
                onValueChange={(value) =>
                  table
          ...
          <TabsContent value={activeTab} className="mt-4">
                  ...
                  {table.getHeaderGroups().map((headerGroup) => (
                    <TableRow key={headerGroup.id}>
                      {headerGroup.headers.map((header) => (
                        <TableHead key={header.id} className="font-[montserrat]">
            ...
            <div className="flex items-center justify-between px-4 mt-4">
              <div className="text-muted-foreground hidden flex-1 text-sm md:flex font-[montserrat]">
                ...
                {table.getFilteredRowModel().rows.length} {activeTab} teacher(s).
              </div>
